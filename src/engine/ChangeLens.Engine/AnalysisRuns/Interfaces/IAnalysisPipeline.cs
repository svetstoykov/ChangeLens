...
/// <summary>
///     Defines execution of the deterministic analysis pipeline for one taken run.
/// </summary>
internal interface IAnalysisPipeline
{
    /// <summary>
    ///     Asynchronously runs every planned step for one taken run to a terminal outcome.
    /// </summary>
