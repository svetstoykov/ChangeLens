...
internal sealed class StubGitCommandRunner : IGitCommandRunner
{
    ...
    internal void Enqueue(Result<GitCommandOutput> result) => this._results.Enqueue((_, _) => Task.FromResult(result));
        ...
        CancellationToken cancellationToken)
    {
        ...
        return this._results.Dequeue()(command, cancellationToken);
    }
}
